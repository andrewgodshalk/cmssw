...
config.General.requestName = 'ZC2016_11_TEST'
config.General.workArea = 'crab_projects_ZC2016_11_TEST'
...
#config.Data.outLFNDirBase = '/store/group/leptonjets/noreplica/godshalk/2016-11_ZJNtuples2016_TEST/crab_output'
config.Data.outLFNDirBase = '/store/user/godshalk/noreplica/CRABTEST'
