...
#    NTupleVariable("btagHipCMVA2",   lambda x : getattr(x,"btagHip",-2), help="CMVAV2 with btv HIP mitigation"),
    NTupleVariable("btagNegCSVIVFv2",   lambda x : x.bDiscriminator('newpfNegativeCombinedInclusiveSecondaryVertexV2BJetTags'), help="Negative CSVIVFv2 Tag"),
    #NTupleVariable("btagNegCSVIVFv2",   lambda x : x.bDiscriminator('pfNegativeCombinedInclusiveSecondaryVertexV2BJetTags'), help="Negative CSVIVFv2 Tag"),
